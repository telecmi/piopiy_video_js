...
export default class {
    ...
    answer ( ua, _this, media ) {
        ...
        cmi_session.answer( { mediaConstraints: { 'audio': media.audio, 'video': media.video } } );
    ...
    initSession ( cmisession, _this ) {
        ...
        if ( cmisession._connection ) {
            cmisession._connection.onaddstream = ( e ) => {
                ...
                _this.emit( 'callStream', { code: 200, stream: e.stream } );
            }
        }
